...
/**
 * index.php
 * Versión 10.0 Final - Layout PC Independiente:
 * - Se optimiza la estructura para permitir CSS Grid Areas.
 * - Se agrega clase identificadora al calendario.
 * - Cache Busting: CSS v11.0.
 */
...
$keywords_array = [
    "pico y placa", "pico y placa hoy", "pico y placa $nombre_ciudad", 
    "pico y placa en $nombre_ciudad", "pico y placa $nombre_ciudad hoy", 
    "pico y placa $nombre_ciudad $nombre_tipo", "restricción vehicular $nombre_ciudad",
    "pico y placa $dia_nombre $dia_num de $mes_nombre", "pico y placa $nombre_ciudad $fecha_seo_corta",
    "horario pico y placa $nombre_ciudad", "multa pico y placa $nombre_ciudad",
    "placas restringidas hoy $nombre_ciudad"
];
$meta_keywords = implode(", ", $keywords_array);

if ($fecha_busqueda === $HOY) {
    $titulo_h1_largo = "Pico y Placa hoy en $nombre_ciudad, $fecha_seo_corta";
...
$meta_description = "Consulta el Pico y Placa en $nombre_ciudad para $nombre_tipo hoy $fecha_texto. Estado: $estado_texto. Evita multas y consulta horarios.";
...
<head>
    ...
    <!-- CSS Version 11.0 para forzar actualización -->
...
<body class="<?= $body_class_mode ?>">
    ...
    <main class="app-container">
        ...
        <?php if($nombre_festivo): ?>
            <section class="festivo-alert-card area-festivo">
                🎉 <strong>¡HOY ES FESTIVO!</strong><br>
    ...
    <footer class="app-footer">
        <p>Pico y PL - Colombia 2025 | Versión 10.0</p>
